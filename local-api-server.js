/**
 * Local API Server for MSD Broken Links Analysis Actor
 * 
 * @author MySmartDigital
 * @description Express server for testing the broken links analysis locally
 */
...
app.post('/analyze', async (req, res) => {
    try {
        ...
        console.log(`Starting broken links analysis for: ${startUrl}`);
...
// Start server
app.listen(PORT, () => {
    console.log(`MSD Broken Links API server running on port ${PORT}`);
